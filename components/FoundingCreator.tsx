...
export default function FoundingCreator() {
  ...
  return (
    <section id="early-access" style={{ background: "#F5F5E8", borderTop: "3px solid #000", borderBottom: "3px solid #000" }} className="py-16 px-10">
      <div className="max-w-5xl mx-auto" ref={ref}>
        ...
        <motion.h2
          ...
          style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: "clamp(60px,9vw,104px)", lineHeight: 0.88, letterSpacing: "2px" }}
        >
          BECOME A<br />FOUNDING<br />CREATOR
        </motion.h2>
        ...
        >
          Skip the waitlist. Get priority access to DescendUp's AI engine before the public launch
        </motion.p>
        ...
        >
          ...
          <div>
            <ul className="mb-5 space-y-3">
              {["Zero commissions on revenue", "No setup or hidden fees", "Priority feature access"].map((perk) => (
            ...
            <p className="text-xs text-gray-500 leading-relaxed">
              We are opening our doors to a select group of creators to stress-test our infrastructure.
              In exchange for your feedback, you get full access to the suite for free.
            </p>
          </div>
          ...
          <div className="flex flex-col items-end gap-4">
            ...
            <p className="text-xs text-gray-500 text-center">Selection based on channel eligibility</p>
            <p className="text-xs font-bold text-green-600 text-center">● 6 channels remaining</p>
          </div>
        </motion.div>
      </div>
    </section>
